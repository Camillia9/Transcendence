...
export default function Landing() {
  ...
  return (
    <div className="relative min-h-screen w-full flex flex-col bg-primary-50">
      ...
      {/* Hero */}
      <div className="relative z-10 flex flex-1 flex-col lg:flex-row items-center px-6 md:px-12 lg:px-24 gap-8 lg:gap-16 py-8">
        {/* Gauche — illustration */}
        ...
        <div className="flex-1 flex flex-col gap-5">
          <p className="text-4xl md:text-5xl lg:text-6xl font-medium text-primary-900 leading-snug">
