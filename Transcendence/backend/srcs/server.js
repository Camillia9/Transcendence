...
import googleStrategy from './services/auth/strategies/google.strategy.js';
import gitHubStrategy from './services/auth/strategies/github.strategy.js';

import { initSockets } from './sockets/index.js';
import conversationsRouter from './services/messaging/routes/conversations.routes.js';
import messagesRouter from './services/messaging/routes/messages.routes.js';

import authRouter from './services/auth/routes/auth.routes.js';
import orgaRouter from './services/organization/routes/organization.routes.js';
import invitationRouter from './services/organization/routes/invitation.routes.js';
import projectRouter from './services/projects/routes/project.routes.js';
import taskRouter from './services/projects/routes/task.routes.js';
